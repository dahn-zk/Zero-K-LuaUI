function widget:GetInfo() return {
	name    = "Missile Pinger",
	desc    = "Battlefield Awareness: Pings allied nukes and missiles.",
	author  = "_Shaman",
	date    = "2020-05-01",
	license = "CC-0",
	layer   = -1,
...
local silos = {}
local lastsay = 0
watcheddefs[UnitDefNames["staticnuke"].id] = {points = 60, radius = 910, type = "nuclear strike", life = 45, label_text = "nuke inc"}
watcheddefs[UnitDefNames["tacnuke"].id] = {points = 16, radius = 192/2, type = "tactical nuke", life = 10, label_text = "tacnuke inc"}
watcheddefs[UnitDefNames["napalmmissile"].id] = {points = 16, radius = 512/2, type = "napalm strike", life = 10, label_text = "napalm inc"}
watcheddefs[UnitDefNames["empmissile"].id] = {points = 16, radius = 280/2, type = "EMP", life = 13, label_text = "emp inc"}
watcheddefs[UnitDefNames["seismic"].id] = {points = 16, radius = 256/2, type = "tactical nuke 2", life = 13, label_text = "quake inc"}
local empty = {}
