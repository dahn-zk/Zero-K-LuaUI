...
function widget:Initialize()
	...
	WG.COFC_2_Enabled = true
	WG.COFC_2_SetCameraTarget = SetCameraTarget
	WG.COFC_2_SetCameraTargetBox = SetCameraTargetBox

	--for external use, so that minimap can scale when zoomed out
	WG.COFC_2_SkyBufferProportion = 0
