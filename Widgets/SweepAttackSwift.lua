...
function widget:GetInfo() return {
  name         = "SweepAttackSwift",
  desc         = "["..version.."] Swifts sweep area to search for stealthy units",
...
local Locust_NAME = "planefighter"
...
local LocustUnitDefID = UnitDefNames["planefighter"].id
